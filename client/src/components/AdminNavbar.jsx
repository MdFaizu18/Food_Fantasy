...
export default function AdminNavbar(props) {
    ...
    const drawer = (
        <div>
            <Box sx={{ display: 'flex', justifyContent: 'left', placeItems: 'center', gap: '10px' }}  >
                <img src={AppLogo} alt="AppLogo" height="60px" width="60px" />
                <Box sx={{ display: 'flex' }}>
                    <Typography color={'red'} variant='h6'>Food</Typography>
            ...
            <List sx={{marginTop:'15%'}}>
                ...
                <Link to="/admin/items" style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                <Link to="/admin/orders" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <ListItem key={3} disablePadding>
                        <ListItemButton sx={{ marginLeft: '5%' }}>
                            <ListItemIcon>
                                <WhereToVoteIcon sx={{ color: 'yellowgreen' }} />
                            </ListItemIcon>
                ...
                <Link to="/admin/reservation" style={{ textDecoration: 'none', color: 'inherit' }}>
            ...
            <List>
                ...
                <Link to="/admin/favourite" style={{ textDecoration: 'none', color: 'inherit' }}>
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Drawer
                    variant="permanent"
                    sx={{
                        display: { xs: 'none', sm: 'block' }, position: 'static',
                        '& .MuiDrawer-paper': { boxSizing: 'border-box', width: drawerWidth },
                    }}
                    open
                >
